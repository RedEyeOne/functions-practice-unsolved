...
// Your code goes here...
export const doesArrayIncludeItemsBetweenVals = (arr, val1, val2) => {
  for (let num of arr) {
...
// Your code goes here...
export const getValueWithConditionOne = (a ,b) => {
  if (a === 40 && b === 40) {
    return a + b;
  } else {
    return (a + b) * 2;
...
export const getValueWithConditionTwo = (a, b) => {
  if (a === 40 && b === 40) {
    return a + b;
  } else {
    return (a + b) * 2;
...
export const getValueWithConditionThree = (a, b) => {
  if (a === 40 && b === 40) {
    return a + b;
  } else {
    return (a + b) * 2;
