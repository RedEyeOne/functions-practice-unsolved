...
import { stringify } from "vitest/utils.js";
...
// Your code goes here...
function logMessageWithMyName(slimShady) {
	console.log("My name is " + stringify(slimShady) + "!");
}
logMessageWithName("james");
...
// Your code goes here...
function logMyInfo(slimShady, age) {
	console.log(
		"My name is " +
			stringify(slimShady) +
			". I am " +
